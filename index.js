...
// middleware
const corsOptions = {
  origin: ['http://localhost:5173', 'http://localhost:5174', 'https://stayvista-new.web.app'],
  credentials: true,
...
const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASS}@cluster0.mquum9d.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0`;
